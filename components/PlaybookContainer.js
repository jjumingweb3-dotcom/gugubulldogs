  ...
  return (
    <div className="flex-grow flex flex-col">
      ...
      <main className="max-w-6xl w-full mx-auto px-4 md:px-8 py-6 flex-grow space-y-6">
        ...
        <div className="flex items-center justify-between border-b border-gray-800 pb-3 gap-3">
          <div className="flex items-center p-1 bg-gray-900 border border-gray-700/80 rounded-2xl w-full sm:w-auto">
            <button
            ...
            <button
              ...
              className={`flex-1 sm:flex-initial flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-xs md:text-sm font-bold transition-all duration-200 cursor-pointer ${
                viewMode === 'summary'
                  ? 'bg-amber-500 text-gray-950 shadow-[0_4px_16px_rgba(245,158,11,0.3)] font-black'
          ...
          {viewMode === 'list' && (
            <button
              onClick={() => setViewMode('summary')}
              className="hidden sm:flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-amber-500/10 border border-amber-500/30 hover:bg-amber-500/20 text-amber-400 text-xs font-bold transition-all cursor-pointer"
            >
              <Trophy className="w-3.5 h-3.5" />
              <span>대회별 승패 모아보기 ➔</span>
            </button>
          )}
        </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    {selectedTournament && (
                      <button
                        onClick={() => setViewMode('summary')}
                        className="px-2 py-0.5 rounded-lg bg-amber-500/10 border border-amber-500/30 text-amber-400 text-[10px] font-bold hover:bg-amber-500/20 transition-all flex items-center gap-1 cursor-pointer"
                      >
                        <Trophy className="w-3 h-3" />
                        <span>이 대회 승패 모아보기</span>
                      </button>
                    )}
                  </div>
